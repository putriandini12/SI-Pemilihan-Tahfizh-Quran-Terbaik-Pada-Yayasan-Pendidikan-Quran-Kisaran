        ...
        <div class="col-xs-12">
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h3 class="panel-title" style="color: black; font-weight: bold;">Form Edit Data Kriteria</h3>
                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button type="submit" class="btn btn-danger">
                                    <span style="color: black; font-weight: bold;" class="fa fa-edit" ></span> Edit Data Kriteria</button>
                            </div>
                        </div>
                    </form>
