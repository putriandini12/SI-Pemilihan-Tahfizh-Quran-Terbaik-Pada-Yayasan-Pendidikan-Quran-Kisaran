    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-danger">
                <strong style="color: black; font-weight: bold;">Selamat Datang Di Pemilihan Tahfizh Terbaik</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h3 class="panel-title" style="color: black; font-weight: bold;">Data Tahfizh</h3>
                </div>
