...
<nav class="navbar bg-danger navbar-fixed-top">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand " style="color: black; font-weight: bold;"  href="?page=utama">Sistem Informasi Pemilihan Tahfizh Terbaik</a>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown text-secondary">
                    ...
                    <ul class="dropdown-menu">
                        <li><a style="color: black; font-weight: bold;" href="?page=tahfiz&actions=tampil">Data Calon Tahfizh</a></li>
                    ...
                    <ul class="dropdown-menu">
                        <li><a style="color: black; font-weight: bold;" href="?page=tahfiz&actions=report">Laporan Data Calon Tahfizh</a></li>
